...
function SectionSliderTwo() {
  const sectionSlider = document.querySelectorAll('.js-section-sliderTwo');
  if (!sectionSlider.length) return;
...
function SectionSliderThree() {
  const sectionSlider = document.querySelectorAll('.js-section-sliderThree');
  if (!sectionSlider.length) return;
...
function SectionSliderFour() {
  const sectionSlider = document.querySelectorAll('.js-section-sliderFour');
  if (!sectionSlider.length) return;
